...
#answer_path  = "/work/choutilin1/out_vars33/vars33_L/out_lite0000.nc"
answer_path  = "/work/choutilin1/data_4d/inf/2015.h5"
predict_path = "/work/choutilin1/out_vars33/vars33_U/temp_0000.nc"
#var_ids = [3]
var_ids = [25,26]
...
for var in var_ids:
    ...
    im2 = ax2.imshow(predict_data["var"+str(var-1)][0,:,:]*lsm, animated=True, vmin=minmax[var][0],vmax=minmax[var][1])
    ax1.tick_params(labelleft=False, labelbottom=False)
    ax2.tick_params(labelleft=False)
    tmp = ax1.set_ylabel("ground_truth")
    tmp = ax2.set_ylabel("prediction")
    ...
    def animate_func(i):
        ...
        im2.set_data(predict_data["var"+str(var-1)][i,:,:]*lsm)
        return [im1,im2]
