...
#
# ---- settings
config_name=vars33_I
out_name=/work/choutilin1/out_vars33/vars33_I/out_0000.nc
targ_name=/work/choutilin1/out_vars33/vars33_I/targ_0000.nc
date
...
$TORCHRUN --master_port=$FREE_PORT \
	...
	--inference_target_path=$targ_name \
	--run_num "01" \
        --inference_ic=0 \
